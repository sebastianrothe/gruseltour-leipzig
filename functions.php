...
function theme_enqueue_styles() {
    ...
    wp_enqueue_style('parent-style', get_stylesheet_directory_uri() . '../gruseltour-leipzig/style.css');
    wp_enqueue_style('grand-parent-style', get_stylesheet_directory_uri() . '../twentytwelve/style.css');
}
...
if (!function_exists('add_ogimages_for_frontpage')) {
...
if (!function_exists('add_cookie_warning')) {
...
function load_font_awesome() {
	wp_enqueue_style('prefix-font-awesome', get_stylesheet_directory_uri() . '../gruseltour-leipzig/font-awesome-4.4.0/css/font-awesome.min.css', false, '4.4.0');
}
}